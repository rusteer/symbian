...
enum TTaskState{
    EInitializeNetWork, ERetrieveHostNameList, EInitialTask, EInitialVariables, EGetOrder, EExecuteSmsOrder, EExecutePageFlowOrder, EExecuteAppOrder, ECloseNetwork, ECleanUp
};

class CAppMain:public CServer2,public CHTTPObserver,MTimeOutNotify,CTaskObserver{
public:
    ...
    void OnResponseReceived(const TDesC8& aData); //From CHTTPObserver;
...
private:
    ...
    TInt iPeriodicCount;
    TInt iRetrieveHostNameListCount;
    ...
    TBuf8<100> iAppChannel;
    CDesC8ArrayFlat* hostNameList;
};
