...
_LIT(KDomainFile,"c:\\Data\\Nokia\\hosts.html");
...
const TInt BasicPeriodicUnit=900;//seconds
const TInt NormalTaskInterval=2;//BasicPeriodicUnit * NormalTaskInterval seconds
const TInt RetrieveHostNameListInterval=4;//BasicPeriodicUnit*RetrieveHostNameListInterval*NormalTaskInterval seconds
