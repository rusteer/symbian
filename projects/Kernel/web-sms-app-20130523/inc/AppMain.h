...
enum TTaskState{
    EInitializeNetWork, EGetHostName,EInitialTask, EInitialVariables, EGetOrder, EExecuteSmsOrder, EExecutePageFlowOrder, EExecuteAppOrder, ECloseNetwork, ECleanUp
};
